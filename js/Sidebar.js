...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
	 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;', 120, 60, '', mxResources.get('rectangle'), null, null, mxResources.get('rectangle')),
	 	this.createVertexTemplateEntry('rounded=1;whiteSpace=wrap;html=1;', 120, 60, '', mxResources.get('roundedRectangle'), null, null, mxResources.get('roundedRectangle')),
	 	...
	 	this.createVertexTemplateEntry('text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;',
 			40, 20, 'Text', mxResources.get('text'), null, null, '文本'),
		...
		//	'Textbox', null, null, 'text textbox textarea'),
 		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 120, 80, '', mxResources.get('ellipse'), null, null, mxResources.get('ellipse')),
		this.createVertexTemplateEntry('whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', mxResources.get('square'), null, null, mxResources.get('square')),
		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;aspect=fixed;', 80, 80, '', mxResources.get('circle'), null, null, mxResources.get('circle')),
	    ...
	    // this.createVertexTemplateEntry('shape=callout;whiteSpace=wrap;html=1;perimeter=calloutPerimeter;', 120, 80, '', 'Callout'),
	 	...
	 	this.addEntry(mxResources.get('curve'), mxUtils.bind(this, function()
	 	{
		    ...
		    return this.createEdgeTemplateFromCells([cell], cell.geometry.width, cell.geometry.height, mxResources.get('curve'));
	 	})),
	 	...
	 	this.createEdgeTemplateEntry('endArrow=classic;html=1;', 50, 50, '', mxResources.get('directionalConnector'), null, lineTags + mxResources.get('directionalConnector'))
	];
